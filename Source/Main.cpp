...
//==============================================================================
class AudioAppJUCE : public juce::JUCEApplication
{
public:
    //==============================================================================
    AudioAppJUCE() {}

    const juce::String getApplicationName() override { return "Reassign"; }
    ...
    */
    ...
    public:
            ...
            : juce::DocumentWindow (name, juce::Colours::lightgrey, juce::DocumentWindow::allButtons)
        {
            ...
            // createMainComponent hides detail
...
START_JUCE_APPLICATION (AudioAppJUCE)
